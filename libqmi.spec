...
Requires: libqmi-bin
Requires: libqmi-lib
Requires: libqmi-data
Requires: libqmi-license
Requires: libqmi-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1534093783
...
export SOURCE_DATE_EPOCH=1534093783
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/libqmi
cp COPYING %{buildroot}/usr/share/doc/libqmi/COPYING
cp COPYING.LIB %{buildroot}/usr/share/doc/libqmi/COPYING.LIB
%make_install
...
/usr/share/gtk-doc/html/libqmi-glib/libqmi-glib-API-break-replacements.html
...
/usr/lib64/libqmi-glib.so.5.3.0

%files license
%defattr(-,root,root,-)
/usr/share/doc/libqmi/COPYING
/usr/share/doc/libqmi/COPYING.LIB
