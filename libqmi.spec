...
Source0  : https://www.freedesktop.org/software/libqmi/libqmi-1.24.2.tar.xz
...
%prep
%setup -q -n libqmi-1.24.2
cd %{_builddir}/libqmi-1.24.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576521556
...
cp %{_builddir}/libqmi-1.24.2/COPYING %{buildroot}/usr/share/package-licenses/libqmi/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libqmi-1.24.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/libqmi/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
